        ...
        <div class="flex flex-row gap-8 w-fit">
                ...
                " v-bind="pageLimitSelected.toString">
                    ...
                    <SelectContent>
                        <SelectGroup>
                            ...
                            <SelectItem v-for="(page_limit_option, index) in selectionPageLimit" :key="index"
            ...
            <div class="flex flex-row gap-2 items-center whitespace-nowrap">
                ...
                <Select v-bind="sortKey.toString">
                    ...
                    <SelectContent>
                        <SelectGroup>
                            ...
                            <SelectItem v-for="(sort_option, index) in sortOptions" :key="index"
                                :value="sort_option['key']" @click="changeSort(sort_option['key'], sortDirection)">
                                {{ sort_option['label'] }}
                            </SelectItem>
                        </SelectGroup>
                    </SelectContent>
                ...
                <div class="cursor-pointer flex gap-1 items-center">
                    <Icon icon="oi:sort-descending" class="h-5 w-5" v-if="sortDirection == SortDirection.DESC"
                        @click="changeSort(sortKey, SortDirection.ASC)" />
                    <Icon icon="oi:sort-ascending" class="h-5 w-5" v-else
