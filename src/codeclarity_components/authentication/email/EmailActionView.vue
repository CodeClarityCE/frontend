...
<template>
    <main class="p-12">
        <EmailActionJoinOrg v-if="props.page === 'join_org'" />
        <PasswordResetForm v-else-if="props.page === 'reset_password'"></PasswordResetForm>
        <ConfirmRegistration v-else></ConfirmRegistration>
    </main>
</template>
