<template>
    ...
    <div class="grid gap-8 lg:grid-cols-3">
        ...
        <!-- Recommended Actions -->
        <InfoCard title="Recommended Actions" icon="solar:lightbulb-bold" variant="primary">
            <div class="space-y-4 max-h-80 overflow-y-auto">
                <div
        ...
        <!-- Quick Navigation -->
        <InfoCard title="Quick Navigation" icon="solar:compass-bold" variant="primary">
            <div class="space-y-4 max-h-80 overflow-y-auto">
                <div
                    ...
                    class="flex items-start gap-4 p-4 rounded-xl bg-gray-50 border border-gray-100 hover:bg-gray-100 transition-colors cursor-pointer"
                >
                    <div class="flex-shrink-0 p-2 rounded-lg" :class="getVariantClass(nav.variant)">
