...
const filteredNotifications = computed(() => {
  ...
  filtered = filtered.filter(
    (notification) => !shouldFilterNotification(notification),
  );
    ...
    filtered = filtered.filter((notification) => {
      switch (selectedFilter.value) {
        ...
        case "production":
          return (
            notification.content_type ===
              NotificationContentType.PackageUpdate &&
            notification.content?.dependency_type === "production"
          );
        case "development":
          return (
...
const totalPages = computed(() =>
  Math.ceil(totalFilteredCount.value / entriesPerPage),
);
          ...
          >
            ...
            <div v-else-if="notification.content_type === 'package_update'">
              ...
              >
                ...
                <div
                  v-if="
                    notification.content && notification.content.package_name
                  "
                    ...
                    <div>
                      ...
                      >
                        <span
                          ...
                          >{{ getVersionInfo(notification).fromVersion }}</span
                        >
                        <Icon
                          :icon="
                        ...
                        >
                          ...
                          {{
                            getVersionInfo(notification)
                              ...
                              .toUpperCase() +
                            getVersionInfo(notification).upgradeType.slice(1)
                          }}
                        </span>
              ...
              <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                ...
                >
                  ...
                  >
                    ...
                    <span
                      >Critical:
                      {{ notification.content.severity_counts.CRITICAL }}</span
                    >
                  </div>
                  <div
                    v-if="
                  ...
                  >
                    ...
                    <span
                      >Low: {{ notification.content.severity_counts.LOW }}</span
                    >
                  </div>
                </div>
