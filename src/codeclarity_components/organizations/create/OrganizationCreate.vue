            ...
            <div class="mt-6">
                <form class="space-y-6" @submit="onSubmit">
                    ...
                    <FormField v-slot="{ componentField }" name="name">
                        <FormItem>
                            <FormLabel class="block text-sm font-semibold text-theme-black mb-2">
        ...
        >
            <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-semibold text-theme-black mb-2">Team Collaboration</h3>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-semibold text-theme-black mb-2">Project Management</h3>
                    <p class="text-theme-gray text-sm">
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-semibold text-theme-black mb-2">Enhanced Security</h3>
                    <p class="text-theme-gray text-sm">
        ...
        >
            <div class="mt-6 space-y-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h4 class="font-semibold text-theme-black mb-1">Invite Team Members</h4>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h4 class="font-semibold text-theme-black mb-1">Set Up Integrations</h4>
                        <p class="text-sm text-theme-gray">
                            Connect your GitHub or GitLab repositories to start analyzing your code.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h4 class="font-semibold text-theme-black mb-1">Configure Policies</h4>
                        <p class="text-sm text-theme-gray">
                            Define security policies and analysis rules to match your organization's
                            needs.
                        </p>
                    </div>
                </div>
