...
export interface AddGitlabIntegrationRequestOptions extends AuthRepoMethodPostRequestOptions<GilabIntegrationAdd> {
  orgId: string;
}

export interface AddGithubIntegrationRequestOptions extends AuthRepoMethodPostRequestOptions<GithubIntegrationAdd> {
  orgId: string;
}

export interface UpdateGithubIntegrationRequestOptions extends AuthRepoMethodPatchRequestOptions<GithubIntegrationUpdate> {
  orgId: string;
  integrationId: string;
}

export interface UpdateGitlabIntegrationRequestOptions extends AuthRepoMethodPatchRequestOptions<GitlabIntegrationUpdate> {
  orgId: string;
  integrationId: string;
}
...
export class IntegrationsRepository extends BaseRepository {
  async getGithubIntegration(
    ...
    return Entity.unMarshal<GithubIntegration>(
      response.data,
      GithubIntegration,
    );
  }
  ...
  async getGitlabIntegration(
    ...
    return Entity.unMarshal<GitlabIntegration>(
      response.data,
      GitlabIntegration,
    );
  }
  ...
  async getVCS(
    options: GetVCSIntegrationsRequestOptions,
  ): Promise<PaginatedResponse<VCS>> {
    ...
    const res = Entity.unMarshal<PaginatedResponse<VCS>>(
      response,
      PaginatedResponse<VCS>,
    );
