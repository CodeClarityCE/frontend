...
async function validateGitlabInstanceUrl(): Promise<void> {
  try {
    gitlabInstanceUrlValidationSchema.parse({
      url: formGitlabInstanceUrl.value,
    });
...
<template>
        ...
        >
            ...
            <AlertDescription class="flex flex-row gap-2 items-center">
              ...
              <div v-if="errorCode">
                ...
                <div
                  ...
                  class="text-red-700"
                >
                  Your token does not have the required permissions. Please
                  select both
          ...
          >
                  ...
                  >
                    <div class="flex flex-col items-center gap-2">
                      ...
                      <div class="text-center">
                        ...
                        >
                          {{ formGitlabInstanceUrl.replace("https://", "") }}
                        </div>
                      </div>
                    </div>
                  </Button>
            ...
            >
              ...
              <span v-if="mode === FormMode.CREATE"
                >Connect GitLab Integration</span
              >
            ...
            >
              ...
              <div class="text-xs text-blue-700">
                ...
                stored securely. We only use it to access your repositories for
                security analysis.
              </div>
            </div>
          </Form>
                ...
                >
                  ...
                  >
                    ...
                    <div class="text-left">
                      ...
                      <div class="text-xs opacity-90">Complete API Access</div>
                    </div>
                  </Button>
                </a>
  ...
  <CenteredModal ref="selfHostedModalRef">
    <template #title>
      <div class="text-xl font-semibold text-theme-black">
    ...
    <template #content>
      <div class="space-y-4 max-w-md">
        <p class="text-theme-gray">
          Enter the URL of your self-hosted GitLab instance:
        </p>
        <input
