        ...
        <div class="max-w-7xl mx-auto p-6">
            <div class="flex flex-col gap-6">
                ...
                <div v-if="!loading">
                    ...
                    >
                        <template #content>
                            <div v-if="memberships.length === 0" class="bg-gray-50 border border-gray-200 rounded-lg p-12 text-center">
                                <div class="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                                    <Icon icon="solar:buildings-3-bold-duotone" class="text-3xl text-gray-400" />
                                </div>
                                <h3 class="text-lg font-semibold text-gray-900 mb-2">No organizations found</h3>
                                <p class="text-gray-600 mb-4">You don't have any organizations yet or no organizations match your search.</p>
                                <RouterLink
                ...
                <div v-if="loading" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    <div v-for="i in 8" :key="i" class="bg-gray-50 border border-gray-200 rounded-lg p-4 animate-pulse">
                ...
                <!-- Error State -->
                <div v-if="error" class="bg-gray-50 border border-gray-200 rounded-lg p-12 text-center">
                    <div class="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <Icon icon="solar:danger-triangle-bold-duotone" class="text-3xl text-red-600" />
                    </div>
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Failed to load organizations</h3>
                    <p class="text-gray-600 mb-4">We encountered an error while loading your organizations.</p>
                    <button
                        class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200"
                        @click="fetch()"
                    >
