            ...
            <div v-if="orgInfo" class="flex flex-col gap-8">
                <div>
                    ...
                    <div class="flex flex-row gap-4 flex-wrap font-normal justify-center">
                        ...
                        <template v-if="!orgInfo.personal">
                            <div class="cursor-pointer w-[calc(50%-10px)] border min-w-0 rounded-lg p-5 font-normal"
                                title="Leave the organization." @click="
                                    orgActionId = orgId;
                            ...
                            <div class="cursor-pointer w-[calc(50%-10px)] border min-w-0 rounded-lg p-5 font-normal border-redBorder bg-redLight text-destructive"
                                v-if="orgInfo.role == MemberRole.OWNER" title="Delete the organization." @click="
                                    orgActionId = orgId;
            ...
            <div>
                ...
                <div class="flex lex-row gap-5 flex-wrap faq-wrapper">
                    <FaqBox>
                        ...
                        <template #answer>A personal organization is an organization that is created
                    ...
                    <FaqBox>
                        ...
                        <template #answer>An integration is a 'connection' to one of our offered external
                    ...
                    <FaqBox>
                        ...
                        <template #answer>A policy is a 'document' in which you can define certain behaviours of
                            our analyzers.</template>
                    </FaqBox>
                    <FaqBox>
                        <template #question>Can I add users to an organization?</template>
                        <template #answer>Yes, you can. The only exception being personal organizations. To add a
                    ...
                    <FaqBox>
                        ...
                        <template #answer>Yes, you can. Simply click the 'revoke' button in the invitations
                            overview.</template>
                    </FaqBox>
                    <FaqBox>
                        <template #question>Can I remove a user from an organization?</template>
                        <template #answer>Yes, you can. Simply click the 'remove' button in the members overview.
                    ...
                    <FaqBox>
                        ...
                        <template #answer>No, you cannot. The role of 'Owner' is reserved to users that created
                            the organization only.</template>
                    </FaqBox>
                    <FaqBox>
                        <template #question>How long until organization invites expire?</template>
                        <template #answer>An organization invite expires after three days for security reasons.
                    ...
                    <FaqBox>
                        ...
                        <template #answer>Yes, they are. Owners and moderators can view the audit logs of an
                            organization for accountability reasons.</template>
                    </FaqBox>
                    <FaqBox>
                        <template #question>Can I recover a deleted organization?</template>
                        <template #answer>No, you cannot. Organization deletion is a permanent action and cannot
                            be undone.</template>
                    </FaqBox>
                </div>
            </div>
