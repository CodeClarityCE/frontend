...
async function updateAutoResolveSetting(enabled: boolean): Promise<void> {
  if (!authStore.getAuthenticated || !authStore.getToken || !orgInfo.value)
    return;
          ...
          >
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <p class="text-sm text-theme-gray">
                  Automatically resolve tickets when their vulnerabilities are
                  no longer detected in scans
                </p>
              </div>
            </div>
            <Switch
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-theme-gray">
                  An integration is a 'connection' to one of our offered
                  external services. For now, you can add integrations with
                  GitLab and GitHub.
                </p>
              </div>
            </div>
