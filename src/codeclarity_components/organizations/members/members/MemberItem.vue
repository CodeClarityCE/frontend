    ...
    try {
      ...
      if (err instanceof BusinessLogicError) {
        if (err.error_code === APIErrors.NotAuthorized) {
          ...
          void errorToast(
            "Failed to kick the user, because you cannot kick yourself.",
          );
...
<template>
  <tr>
    ...
    <td>
      ...
      <div
        v-if="member.role === MemberRole.ADMIN"
      ...
      <div
        v-if="member.role === MemberRole.USER"
  ...
  <CenteredModal ref="centeredModalRef">
    ...
    <template #content>
      ...
      >
        <div v-if="centeredModalAction === ModalAction.Kick">
          <div>
            Are you sure you want to kick the user from the organization?
          </div>
