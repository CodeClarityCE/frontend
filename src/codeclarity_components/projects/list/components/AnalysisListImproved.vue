...
function toggleAnalysis(analysisId: string): void {
  expandedAnalysisId.value =
    expandedAnalysisId.value === analysisId ? null : analysisId;
}
...
<template>
  <div class="space-y-3">
    ...
    <div v-if="latestAnalyses.scheduled">
      ...
      >
        <div
          class="hover:bg-gray-50/40 transition-all duration-200 rounded-r-lg"
        >
          <!-- Analysis header -->
          <div
          ...
          >
            <div class="pt-3 space-y-2">
              <!-- Analysis steps -->
              <div
                v-if="shouldShowSteps(latestAnalyses.scheduled)"
                class="space-y-1"
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      {{
                        formatExecutionTime(stage.Started_on, stage.Ended_on)
                      }}
                    </span>
                  </div>
                </div>
        ...
        >
              ...
              <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-2">
                  <div class="flex items-center gap-1">
                    ...
                    <span class="text-sm font-semibold text-gray-900">
                      {{
                        latestAnalyses.oneTime.status === AnalysisStatus.STARTED
                          ? "Running"
                          : latestAnalyses.oneTime.status ===
                                AnalysisStatus.COMPLETED ||
                              latestAnalyses.oneTime.status ===
          ...
          >
            <div class="pt-3 space-y-2">
              <!-- Analysis steps -->
              <div
                v-if="shouldShowSteps(latestAnalyses.oneTime)"
                class="space-y-1"
              >
                <p class="text-xs font-medium text-gray-600 mb-2">
                  Analysis Steps:
    ...
    <Dialog v-model:open="showScheduledHistoryModal">
      <DialogContent class="max-w-4xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            All scheduled analyses for this project
          </DialogDescription>
        </DialogHeader>
    ...
    <Dialog v-model:open="showOneTimeHistoryModal">
      <DialogContent class="max-w-4xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            All one-time analyses for this project
          </DialogDescription>
        </DialogHeader>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            undone and will permanently delete all results.
          </DialogDescription>
        </DialogHeader>
