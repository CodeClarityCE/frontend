...
<template>
  ...
  >
        ...
        <div class="flex flex-col gap-3 flex-1 min-w-0">
          ...
          <div class="flex items-center gap-2 text-xs text-theme-gray/60">
            <Icon
              ...
              class="h-3.5 w-3.5 text-theme-primary"
            />
            <span
              >Imported {{ formatDate(project.added_on, "MMM DD, YYYY") }}</span
            >
          </div>
        </div>
    ...
    <CardContent class="relative pt-0 pb-6">
      ...
      <div
        v-if="project.analyses && project.analyses.length > 0"
        class="space-y-3"
      >
  ...
  <CenteredModal ref="projectDeleteModalRef">
    ...
    <template #content>
      <div class="space-y-4 max-w-md">
        ...
        >
          <div class="text-sm font-medium text-theme-black">
            {{ project.name }}
          </div>
        ...
        <Alert variant="destructive">
          ...
          <AlertDescription>
            This action cannot be undone. All analyses and data associated with
    ...
    <template #buttons>
      <Button variant="outline" @click="projectDeleteModalRef?.toggle()">
        Cancel
      </Button>
      <Button
        variant="destructive"
