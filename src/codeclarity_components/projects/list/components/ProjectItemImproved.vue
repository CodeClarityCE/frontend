...
function getProjectIcon(): string {
  if (props.project.type === IntegrationProvider.GITLAB)
    return "devicon:gitlab";
  if (props.project.type === IntegrationProvider.GITHUB)
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            cannot be undone and will permanently delete all analyses and
            results.
          </DialogDescription>
        </DialogHeader>
