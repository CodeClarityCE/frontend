...
describe('LicenseComponent.vue', () => {
    ...
    it('handles unknown license category', () => {
        ...
        expect((wrapper.vm as any).licenseTypeInfo.riskLevel).toBe('Review Required');
    });
    ...
    it('formats property names correctly', () => {
        ...
        expect((wrapper.vm as any).formatPropertyName('commercial-use')).toBe('Commercial Use');
    ...
    it('extracts domain from reference URL correctly', () => {
        ...
        expect((wrapper.vm as any).referenceDomain('https://opensource.org/licenses/MIT')).toBe(
            'opensource.org'
        );
        expect(
            (wrapper.vm as any).referenceDomain('https://www.apache.org/licenses/LICENSE-2.0')
        ).toBe('www.apache.org');
    });
    ...
    it('gets correct property descriptions', () => {
        ...
        expect((wrapper.vm as any).getPermissionDescription('commercial-use')).toContain(
            'commercial purposes'
        );
        expect((wrapper.vm as any).getConditionDescription('include-copyright')).toContain(
            'copyright notice'
        );
    ...
    it('gets correct property icons', () => {
        ...
        expect((wrapper.vm as any).getPropertyIcon('commercial-use')).toBe('tabler:building-store');
        expect((wrapper.vm as any).getPropertyIcon('modifications')).toBe('tabler:edit');
        expect((wrapper.vm as any).getPropertyIcon('liability')).toBe('tabler:shield-off');
    });
