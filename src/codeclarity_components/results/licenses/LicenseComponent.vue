...
const hasIssues = computed(() => {
  return (
    props.license.license_compliance_violation || props.license.unable_to_infer
  );
});
...
const getPropertyDescription = (
  ...
  return (
    descriptions[property as keyof typeof descriptions] ||
                    ...
                    <Tooltip>
                      <TooltipTrigger as-child>
                        <Badge variant="secondary" class="text-xs px-2 py-1">
                          <Icon icon="tabler:package" class="w-3 h-3 mr-1" />
                          {{ dependencyCount }} dependencies
                        </Badge>
                      </TooltipTrigger>
                      <TooltipContent>
                        <div class="text-sm">
                          {{ dependencyCount }} dependencies use this license
                        </div>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
        ...
        <div v-if="props.license.license_properties" class="space-y-6">
          ...
          >
            ...
            <div class="bg-emerald-50 p-4 space-y-3">
              <div
                v-for="permission in props.license.license_properties
                  .permissions"
                :key="permission"
          ...
          >
            <div class="bg-red-100 px-4 py-3 border-b border-red-200">
              <div class="flex items-center gap-2">
                ...
                <Badge
                  variant="secondary"
                  class="text-xs bg-red-50 text-red-700"
                >
            ...
            <div class="bg-red-50 p-4 space-y-3">
              <div
                v-for="limitation in props.license.license_properties
                  .limitations"
                :key="limitation"
