...
vi.mock('@/base_components/utilities/UtilitiesSort.vue', () => ({
    default: {
        ...
        emits: ['update:pageLimitSelected', 'update:sortKey', 'update:sortDirection']
    }
}));
...
describe.skip('PatchingTable.vue', () => {
    ...
    describe('Data Loading', () => {
        ...
        it('should render patches after successful data load', async () => {
            ...
            const patchComponents = wrapper.findAllComponents({ name: 'PatchComponent' });
    ...
    describe('Sorting and Pagination', () => {
        ...
        it('should pass correct props to UtilitiesSort', () => {
            ...
            expect(sortComponent.props('selectionPageLimit')).toEqual([3, 5, 7, 10, 12, 15]);
