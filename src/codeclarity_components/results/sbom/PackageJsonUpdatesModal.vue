...
const packageManagerIcon = computed(() => getPackageManagerIcon(detectedPackageManager.value));
const lockfileName = computed(() => getLockfileName(detectedPackageManager.value));
const installCommand = computed(() => getInstallCommand(detectedPackageManager.value));
const helpText = computed(() => getPackageManagerHelpText(detectedPackageManager.value));
