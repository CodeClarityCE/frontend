...
const securityIssues = computed(() => {
    return (stats.value.number_of_deprecated_dependencies || 0) + 
...
<template>
    <div value="sbom" class="space-y-4">
        ...
        <div class="grid gap-6 lg:grid-cols-12">
            ...
            <Card class="lg:col-span-5 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-950/30 dark:to-indigo-950/30 border-blue-200 dark:border-blue-800">
                    ...
                    <div class="flex items-center justify-between gap-6">
                        ...
                        <div class="flex-1 space-y-3">
                            <div v-if="render" class="space-y-2">
                                <div class="flex items-center justify-between p-2 bg-white/60 dark:bg-gray-800/60 rounded-lg">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-xs text-gray-500">
                                            ({{ Math.round((stats?.number_of_direct_dependencies / stats?.number_of_dependencies) * 100) }}%)
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center justify-between p-2 bg-white/60 dark:bg-gray-800/60 rounded-lg">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-xs text-gray-500">
                                            ({{ Math.round((stats?.number_of_transitive_dependencies / stats?.number_of_dependencies) * 100) }}%)
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center justify-between p-2 bg-white/60 dark:bg-gray-800/60 rounded-lg">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-xs text-gray-500">
                                            ({{ Math.round((stats?.number_of_both_direct_transitive_dependencies / stats?.number_of_dependencies) * 100) }}%)
                                        </span>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="lg:col-span-7 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <Card class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/30 dark:to-purple-950/50 border-purple-200 dark:border-purple-800 hover:shadow-lg transition-shadow">
                    <CardHeader class="pb-2">
                        <div class="flex items-center justify-between">
                            ...
                            <div 
                                ...
                                {{ stats.number_of_direct_dependencies_diff > 0 ? '+' : '' }}{{ stats.number_of_direct_dependencies_diff }}
                            </div>
                        </div>
                    </CardHeader>
                    <CardContent>
                ...
                <Card class="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-950/30 dark:to-emerald-950/50 border-emerald-200 dark:border-emerald-800 hover:shadow-lg transition-shadow">
                    <CardHeader class="pb-2">
                        <div class="flex items-center justify-between">
                            ...
                            <div 
                                ...
                                {{ stats.number_of_dev_dependencies_diff > 0 ? '+' : '' }}{{ stats.number_of_dev_dependencies_diff }}
                            </div>
                        </div>
                    </CardHeader>
                    <CardContent>
                ...
                <!-- Health Score Card -->
                <Card class="bg-gradient-to-br from-amber-50 to-orange-100 dark:from-amber-950/30 dark:to-orange-950/50 border-amber-200 dark:border-amber-800 hover:shadow-lg transition-shadow">
                    <CardHeader class="pb-2">
                        <div class="flex items-center justify-between">
                            ...
                            <div 
                                :class="[
                                    ...
                                    healthScore >= 60 ? 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400' :
                                    'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400'
                                ]">
                ...
                <Card class="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-950/30 dark:to-red-950/50 border-red-200 dark:border-red-800 hover:shadow-lg transition-shadow">
                    <CardHeader class="pb-2">
                        <div class="flex items-center justify-between">
                            <div class="bg-red-500 p-2 rounded-lg">
                                <Icon icon="tabler:shield-exclamation" class="w-5 h-5 text-white" />
                            </div>
                            <div v-if="securityIssues > 0" class="bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400 px-2 py-1 rounded-full text-xs font-medium">
                                Action Needed
                            </div>
                        </div>
                    </CardHeader>
                ...
                <Card class="bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-950/30 dark:to-yellow-950/50 border-yellow-200 dark:border-yellow-800 hover:shadow-lg transition-shadow">
                    <CardHeader class="pb-2">
                        <div class="flex items-center justify-between">
                            <div class="bg-yellow-500 p-2 rounded-lg">
                                <Icon icon="tabler:clock-exclamation" class="w-5 h-5 text-white" />
                            </div>
                            <div v-if="outdatedPercentage > 20" class="bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400 px-2 py-1 rounded-full text-xs font-medium">
                                {{ outdatedPercentage }}%
                            </div>
                        </div>
                    </CardHeader>
                ...
                <Card class="bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-950/30 dark:to-indigo-950/50 border-indigo-200 dark:border-indigo-800 hover:shadow-lg transition-shadow">
                    <CardHeader class="pb-2">
                        <div class="flex items-center justify-between">
                            <div class="bg-indigo-500 p-2 rounded-lg">
                                <Icon icon="tabler:trending-up" class="w-5 h-5 text-white" />
                            </div>
                            <div class="bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400 px-2 py-1 rounded-full text-xs font-medium">
                                Ratio
                            </div>
                        </div>
                    </CardHeader>
        ...
        <div class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900/50 dark:to-gray-800/50 rounded-lg p-6 border">
        ...
        <div v-if="render" class="bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-950/30 dark:to-blue-950/30 rounded-lg p-6 border border-indigo-200 dark:border-indigo-800">
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                        <div v-if="healthScore < 70" class="bg-white/60 dark:bg-gray-800/60 rounded-lg p-3">
                            <div class="flex items-center gap-2 mb-1">
                                <Icon icon="tabler:alert-triangle" class="w-4 h-4 text-amber-500" />
                                <span class="text-sm font-medium text-gray-900 dark:text-gray-100">Health Warning</span>
                            </div>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                                Your project health score is {{ healthScore }}%. Consider updating outdated dependencies.
                            </p>
                        </div>
                        
                        <div v-if="dependencyRatio > 5" class="bg-white/60 dark:bg-gray-800/60 rounded-lg p-3">
                            <div class="flex items-center gap-2 mb-1">
                                <Icon icon="tabler:network" class="w-4 h-4 text-blue-500" />
                                <span class="text-sm font-medium text-gray-900 dark:text-gray-100">High Dependency Ratio</span>
                            </div>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                                You have {{ dependencyRatio }} transitive dependencies per direct dependency. Consider reviewing your dependency choices.
                            </p>
                        </div>
                        
                        <div v-if="securityIssues === 0 && outdatedPercentage < 10" class="bg-white/60 dark:bg-gray-800/60 rounded-lg p-3">
                            <div class="flex items-center gap-2 mb-1">
                                <Icon icon="tabler:check-circle" class="w-4 h-4 text-green-500" />
                                <span class="text-sm font-medium text-gray-900 dark:text-gray-100">Great Job!</span>
                            </div>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                                Your dependencies are well-maintained with no security issues and minimal outdated packages.
                            </p>
                        </div>
                        
                        <div v-if="stats.number_of_dev_dependencies > stats.number_of_non_dev_dependencies" class="bg-white/60 dark:bg-gray-800/60 rounded-lg p-3">
                            <div class="flex items-center gap-2 mb-1">
                                <Icon icon="tabler:code" class="w-4 h-4 text-purple-500" />
                                <span class="text-sm font-medium text-gray-900 dark:text-gray-100">Dev-Heavy Project</span>
                            </div>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                                You have more dev dependencies than production dependencies. This is common for tooling-heavy projects.
                            </p>
                        </div>
                    </div>
                </div>
