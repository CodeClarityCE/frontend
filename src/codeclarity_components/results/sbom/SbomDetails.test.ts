...
describe.skip('SbomDetails.vue', () => {
    ...
    describe('Security Score Calculation', () => {
        it('should calculate security score A for no vulnerabilities', async () => {
            const safeDependency = { ...mockDependency, vulnerabilities: [], severity_dist: {} };
            mockResultsRepository.getDependency.mockResolvedValue({ data: safeDependency });
        ...
        it('should calculate security score D for high vulnerabilities', async () => {
            ...
            mockResultsRepository.getDependency.mockResolvedValue({ data: highVulnDependency });
    ...
    describe('Vulnerability Section', () => {
        ...
        it('should display severity distribution', async () => {
            ...
            const criticalCount = wrapper.find('.severity-item.critical .severity-count');
    ...
    describe('Recommendations', () => {
        ...
        it('should not show transitive recommendation for direct dependencies', async () => {
            ...
            const transitiveRecommendation = wrapper.find('.recommendation-item.transitive');
        ...
        it('should show transitive recommendation for transitive dependencies', async () => {
            ...
            mockResultsRepository.getDependency.mockResolvedValue({ data: transitiveDep });
    ...
    describe('Error Handling', () => {
        it('should handle repository errors gracefully', async () => {
            mockResultsRepository.getDependency.mockRejectedValue(new Error('API Error'));
    ...
    describe('Package Status Helpers', () => {
        ...
        it('should handle missing version information', async () => {
            const noVersionDep = { ...mockDependency, version: null, latest_version: null };
            mockResultsRepository.getDependency.mockResolvedValue({ data: noVersionDep });
        ...
        it('should show Latest status when on latest version', async () => {
            const latestDep = { ...mockDependency, version: '2.0.0', latest_version: '2.0.0' };
            mockResultsRepository.getDependency.mockResolvedValue({ data: latestDep });
