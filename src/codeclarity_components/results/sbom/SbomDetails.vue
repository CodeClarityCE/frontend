...
function isPackageOutdated(releaseDate: Date, latestReleaseDate: Date): boolean {
        ...
        <div v-if="render" class="content-wrapper">
            ...
            <div class="security-stats-grid">
                ...
                <StatCard
                    ...
                    icon="solar:bug-bold"
                    :variant="(dependency.vulnerabilities?.length || 0) > 0 ? 'danger' : 'success'"
                    :subtitle="getVulnerabilityDescription(dependency.vulnerabilities?.length || 0)"
                ...
                <StatCard
                    ...
                    :variant="
                        getCriticalHighCount(dependency.severity_dist) > 0 ? 'danger' : 'success'
                    "
                ...
                <StatCard
                    ...
                    variant="default"
                    :subtitle="
                        dependency.transitive ? 'Transitive dependency' : 'Direct dependency'
                    "
                    :subtitle-icon="
                        dependency.transitive ? 'solar:hierarchy-2-linear' : 'solar:download-linear'
                    "
                />
            </div>
                    ...
                    <div class="comprehensive-content">
                        ...
                        <div class="overview-section health-section">
                            <div class="health-section-header">
                                <Icon icon="solar:shield-check-bold" class="health-header-icon" />
                                <h3 class="health-section-title">Security & Compliance Status</h3>
                            </div>
...
/* Loading states */
:deep(.skeleton) {
    background: linear-gradient(90deg, #f0f0f0 25%, rgba(29, 206, 121, 0.1) 37%, #f0f0f0 63%);
