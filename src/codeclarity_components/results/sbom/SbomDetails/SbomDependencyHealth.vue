...
const isOutdated = computed(() => {
  if (!props.dependency.release_date || !props.dependency.lastest_release_date)
    return false;
  return (
...
const hasVulnerabilities = computed(() => {
  return (
    props.dependency.vulnerabilities &&
    props.dependency.vulnerabilities.length > 0
  );
});
...
const getHealthStatusDescription = (): string => {
  ...
  if (issues.length === 2)
    return `This package has ${issues[0]} and ${issues[1]}.`;
  ...
  <section class="dependency-health-panel">
    <div class="health-content">
      ...
      <div class="health-overview">
        ...
        <div v-else class="health-summary healthy">
          ...
          <div class="summary-content">
            ...
            <p class="summary-description">
              No security vulnerabilities, licensing issues, or outdated
              versions detected.
            </p>
          </div>
        </div>
      ...
      <div v-if="hasHealthIssues" class="health-issues-grid">
        ...
        <div v-if="isOutdated" class="health-issue-card outdated">
          ...
          <div class="issue-content">
            <p class="issue-description">
              This package is
              <strong>{{ getDaysOutdated() }} days</strong> behind the latest
              release.
            </p>
            <div class="issue-recommendation">
              <Icon icon="solar:lightbulb-bold" class="recommendation-icon" />
              <span
                >Consider upgrading <code>{{ dependency.name }}</code> to the
                latest version.</span
              >
            </div>
          </div>
        ...
        <!-- Unlicensed Warning -->
        <div
          v-if="dependency.license === ''"
          class="health-issue-card unlicensed"
        >
          <div class="issue-header">
          ...
          <div class="issue-content">
            <p class="issue-description">
              This dependency appears to be unlicensed.
            </p>
            <div class="issue-recommendation">
              <Icon
                icon="solar:danger-triangle-bold"
              ...
              />
              <span
                >Authors of unlicensed dependencies hold exclusive rights to
                their use, redistribution and modification.</span
              >
            </div>
          </div>
        </div>
