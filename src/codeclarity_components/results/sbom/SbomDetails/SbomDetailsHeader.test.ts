...
vi.mock("@/shadcn/ui/badge", () => ({
  Badge: {
    ...
    props: ["variant", "class"],
    template:
      '<div class="mock-badge" :class="$props.class"><slot></slot></div>',
  },
}));
...
describe("SbomDetailsHeader.vue", () => {
  ...
  describe("Package Information Display", () => {
    ...
    it("should handle complex version strings", () => {
      ...
      expect(wrapper.find(".package-version").text()).toBe(
  ...
  describe("NPM Link", () => {
    ...
    it("should have correct NPM link attributes", () => {
      ...
      expect(npmLink.attributes("title")).toBe(
        "View on NPM (opens in new tab)",
      );
    });
  ...
  describe("Yarn Link", () => {
    ...
    it("should have correct Yarn link attributes", () => {
      ...
      expect(yarnLink.attributes("title")).toBe(
        "View on Yarn (opens in new tab)",
      );
    });
  ...
  describe("Repository Link", () => {
    ...
    it("should have correct repository link attributes", () => {
      ...
      expect(repoLink.attributes("title")).toBe(
    ...
    it("should not render repository link when source is missing", () => {
      ...
      const repoLinks = wrapper.findAll(
        'a[href*="github.com"], a[href*="gitlab.com"]',
      );
