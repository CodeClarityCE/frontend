...
describe('VulnSummaryContent.vue', () => {
    const createMockFinding = (overrides = {}) => {
        ...
        finding.vulnerability_info = {
            ...
            sources: [
                { name: 'NVD', vuln_url: 'https://nvd.nist.gov/vuln/detail/CVE-2021-1234' },
    ...
    describe('Styling and Layout', () => {
        it('should have correct CSS classes for sections', () => {
            ...
            expect(wrapper.find('.bg-white.shadow-md.rounded-lg').exists()).toBe(true);
        ...
        it('should style vulnerability title correctly', () => {
            ...
            expect(wrapper.find('.font-black.text-xl.text-gray-800').exists()).toBe(true);
