...
for (const category in options.value) {
  const categoryData = options.value[category] as {
    data: Record<string, { value: boolean }>;
  };
...
function updateSort(
  _sortKey: ProjectsSortInterface,
...
const showBlacklistedFromFilter = computed<boolean>(() => {
  return (
    filterState.value.filterConfig?.BlacklistState?.data?.show_blacklisted
      ?.value ?? false
  );
});
                    ...
                    >
                      <div class="p-2">
                        ...
                        <div class="text-sm text-gray-600">
                          This vulnerability is marked as a false positive and
                          excluded from results by your vulnerability policy
                        </div>
                        <div
                          v-if="
                  ...
                  <Tooltip>
                    <TooltipTrigger as-child>
                      ...
                      >
                        ...
                        <span>{{ (report.EPSS.Score * 100).toFixed(1) }}%</span>
                      </div>
                    </TooltipTrigger>
                    <TooltipContent
                      class="bg-white border border-gray-300 shadow-lg"
                    ...
                    >
                      <div class="max-w-sm space-y-3 p-3">
                        <div class="flex items-center gap-2">
                          ...
                          />
                          <span class="font-semibold text-base text-gray-900"
                            >CVSS Score: {{ report.Severity.Severity }}</span
                          >
                        </div>
                        <div
                          class="text-sm space-y-2 bg-gray-50 p-3 rounded-lg"
                        >
                          ...
                          <div class="text-gray-600">
                            Industry standard for assessing vulnerability
                            severity (0.0-10.0 scale)
                          </div>
                        </div>
                      </div>
                    </TooltipContent>
                        ...
                        <div class="max-w-sm space-y-2 p-3">
                          ...
                          <div class="text-sm text-gray-600">
                            <div>
                              ...
                              <span
                                :class="{
                                  'text-red-600': affected.PatchType === 'NONE',
                                  'text-amber-600':
                                    affected.PatchType === 'PARTIAL',
                                  'text-green-600':
                                    affected.PatchType === 'FULL',
                                }"
                              >
                                {{
                        ...
                        >
                          <div class="space-y-3 p-3">
                            <div class="flex items-center gap-2">
                              ...
                              <span
                                class="font-semibold text-base text-gray-900"
                                >OWASP {{ getOwaspInfo(owaspID).id }}</span
                              >
                            </div>
                            <div class="space-y-2">
                              <div>
                ...
                <Tooltip>
                  ...
                  >
                    <div class="max-w-sm space-y-2 p-3">
                      ...
                      <div class="text-sm text-gray-600">
                        <div>
                          CVSS metric measuring how easily this vulnerability
                          can be exploited (0.0-10.0)
                        </div>
                        <div class="mt-2">
                          <strong>Score:</strong>
                      ...
                      <div class="space-y-3 p-2">
                        ...
                        <div class="text-sm bg-gray-50 p-2 rounded-lg">
                          ...
                          <div class="text-gray-600 text-xs">
                            ...
                            <span v-else>
                              Partial confidentiality loss - limited scope of
                        ...
                        <div class="text-sm bg-gray-50 p-2 rounded-lg">
                          ...
                          <div class="text-gray-600 text-xs">
                            <span
                              ...
                              "
                            >
                              Total shutdown or denial of service causing
                              sustained outages.
                            </span>
                            <span v-else>
                        ...
                        <div class="text-sm bg-gray-50 p-2 rounded-lg">
                          ...
                          <div class="text-gray-600 text-xs">
                            ...
                            >
                              ...
                              modify or corrupt system data.
                            </span>
                            <span v-else>
                              Limited data modification capability with
                              constrained impact.
                            </span>
                          </div>
                        </div>
