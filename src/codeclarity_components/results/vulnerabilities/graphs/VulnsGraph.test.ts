...
vi.mock('@/shadcn/ui/card', () => ({
    Card: {
        name: 'Card',
        props: ['class'],
        template: '<div class="mock-card" :class="$props.class"><slot></slot></div>'
    },
    CardContent: {
        name: 'CardContent',
        props: ['class'],
        template: '<div class="mock-card-content" :class="$props.class"><slot></slot></div>'
    },
    CardHeader: {
        name: 'CardHeader',
        props: ['class'],
        template: '<div class="mock-card-header" :class="$props.class"><slot></slot></div>'
    },
    CardTitle: {
        name: 'CardTitle',
        props: ['class'],
        template: '<div class="mock-card-title" :class="$props.class"><slot></slot></div>'
    }
}));
...
describe.skip('VulnsGraph.vue', () => {
    ...
    describe('Props Handling', () => {
        it('should accept analysisID prop', () => {
            const wrapper = createWrapper(createMockStats(), { analysisID: 'custom-analysis' });

            expect(wrapper.props('analysisID')).toBe('custom-analysis');
        });

        it('should accept projectID prop', () => {
            const wrapper = createWrapper(createMockStats(), { projectID: 'custom-project' });
