...
const SecurityImpact = defineAsyncComponent({
  loader: (() =>
    import("./components/SecurityImpact.vue")) as () => Promise<Component>,
...
const VulnerabilitiesInfo = defineAsyncComponent({
  loader: (() =>
    import("./components/VulnerabilitiesInfo.vue")) as () => Promise<Component>,
  loadingComponent: LoadingComponent as Component,
  // Delay before showing the loading component. Default: 200ms.
  delay: 200,
  errorComponent: ErrorComponent as Component,
...
const OwaspTopTen = defineAsyncComponent({
  loader: (() =>
    import("./components/OwaspTopTen.vue")) as () => Promise<Component>,
  loadingComponent: LoadingComponent as Component,
  // Delay before showing the loading component. Default: 200ms.
  delay: 200,
  errorComponent: ErrorComponent as Component,
    ...
    <div class="bg-linear-to-r from-slate-50 to-gray-50 rounded-lg p-6 border">
      ...
      <div class="grid gap-6 lg:grid-cols-3">
        ...
        >
          ...
          <CardContent class="flex items-center justify-center grow min-h-50">
