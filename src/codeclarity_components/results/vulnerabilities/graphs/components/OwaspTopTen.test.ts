...
describe('OwaspTopTen.vue', () => {
    ...
    describe('Component Rendering', () => {
        it('should render the main container', () => {
            ...
            expect(wrapper.find('.flex.flex-col.justify-center.items-center.gap-2').exists()).toBe(
                true
            );
        });
    ...
    describe('Data Processing', () => {
        it('should filter out zero values from OWASP categories', () => {
            ...
            expect(chartData.some((item: any) => item.label.includes('A01'))).toBe(true);
            expect(chartData.some((item: any) => item.label.includes('A03'))).toBe(true);
            expect(chartData.some((item: any) => item.label.includes('A05'))).toBe(true);
            expect(chartData.some((item: any) => item.label.includes('A10'))).toBe(true);
            expect(chartData.some((item: any) => item.label === 'Uncategorized')).toBe(true);
        });
        ...
        it('should include uncategorized vulnerabilities when total is less than overall count', () => {
            ...
            const uncategorizedItem = chartData.find((item: any) => item.label === 'Uncategorized');
        ...
        it('should use correct OWASP labels', () => {
            ...
            expect(chartData.some((item: any) => item.label === 'A01: Broken Access Control')).toBe(
                true
            );
            expect(chartData.some((item: any) => item.label === 'A03: Injection')).toBe(true);
            expect(
                chartData.some((item: any) => item.label === 'A05: Security Misconfiguration')
            ).toBe(true);
        });
    ...
    describe('Layout and Styling', () => {
        ...
        it('should center align chart and legend', () => {
            ...
            const container = wrapper.find('.flex.flex-col.justify-center.items-center.gap-2');
