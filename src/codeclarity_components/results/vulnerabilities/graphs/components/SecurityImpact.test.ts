...
describe('SecurityImpact.vue', () => {
    ...
    describe('Component Rendering', () => {
        it('should render the main container', () => {
            ...
            expect(wrapper.find('.flex.flex-row.justify-center.items-center').exists()).toBe(true);
        });
    ...
    describe('Data Processing', () => {
        ...
        it('should map CIA triad values correctly', () => {
            ...
            const confidentialityAxis = axes.find((axis: any) => axis.axis === 'CONFIDENTIALITY');
            const integrityAxis = axes.find((axis: any) => axis.axis === 'INTEGRITY');
            const availabilityAxis = axes.find((axis: any) => axis.axis === 'AVAILABILITY');
    ...
    describe('Layout and Styling', () => {
        ...
        it('should center align radar chart', () => {
            ...
            const container = wrapper.find('.flex.flex-row.justify-center.items-center');
