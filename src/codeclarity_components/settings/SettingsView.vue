            ...
            >
                <div class="space-y-4">
                    ...
                    >
                        ...
                        <div class="flex-1">
                            <h3 class="font-semibold text-theme-black mb-1">Security Settings</h3>
                            <p class="text-sm text-theme-gray mb-3">
            ...
            >
                <div class="space-y-4">
                    ...
                    >
                        ...
                        <div class="flex-1">
                            <h3 class="font-semibold text-theme-black mb-1">Privacy Controls</h3>
                            <p class="text-sm text-theme-gray mb-3">
                    ...
                    >
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-red-600 mb-3">Permanently delete your account</p>
