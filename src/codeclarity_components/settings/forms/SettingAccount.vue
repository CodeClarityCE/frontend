                ...
                <Alert variant="destructive" class="mb-6 border-red-200 bg-red-100">
                    ...
                    <AlertDescription>
                        <div class="text-sm leading-relaxed text-red-800">
                            ...
                            including: uploaded projects, analysis results, organizations, and
                            license policies.
                    ...
                    <DialogContent class="sm:max-w-[425px]">
                        <DialogHeader>
                            ...
                            <DialogDescription class="text-theme-gray">
                                Enter your password to confirm the deletion of your account. This
        ...
        >
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                    ...
                    <div>
                        <h4 class="font-semibold text-theme-black mb-2">Strong Passwords</h4>
                ...
                >
                    ...
                    <div>
                        ...
                        <p class="text-sm text-theme-gray leading-relaxed">
                            Change your password regularly and keep your information up to date.
                        </p>
                    </div>
                </div>
