...
onMounted(async () => {
    ...
    try {
        ...
        sessionStorage.setItem('clickup_oauth_access_token', response.data.access_token);
    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50">
        <div class="max-w-md w-full p-8">
            ...
            <div v-if="status === 'loading'" class="text-center">
                ...
                <h2 class="text-xl font-semibold text-gray-900 mb-2">Connecting to ClickUp...</h2>
                <p class="text-gray-500">Please wait while we complete the authorization.</p>
            </div>
            ...
            <div v-else-if="status === 'success'" class="text-center">
                ...
                <h2 class="text-xl font-semibold text-gray-900 mb-2">Connected Successfully!</h2>
                <p class="text-gray-500">Redirecting you back to complete the setup...</p>
            </div>
