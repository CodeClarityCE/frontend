...
const testResults = ref<Map<ExternalTicketProvider, ConnectionTestResult>>(
  new Map(),
);
...
function getIntegration(
  provider: ExternalTicketProvider,
): IntegrationConfigSummary | undefined {
  ...
  <div class="space-y-6">
    ...
    <div v-if="isLoading && integrations.length === 0" class="py-8 text-center">
      <Icon
        ...
        class="w-8 h-8 animate-spin text-gray-400 mx-auto"
      />
          ...
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <div
                ...
                class="mt-2 text-sm"
                :class="{
                  'text-green-600': getTestResult(providerInfo.provider)
                    ?.success,
                  'text-red-600': !getTestResult(providerInfo.provider)
                    ?.success,
                }"
              >
