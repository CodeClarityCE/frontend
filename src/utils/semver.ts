 ...
 */
export function shouldRecommendUpgrade(currentVersion: string, newVersion: string): boolean {
 ...
 */
export function getUpgradeType(currentVersion: string, newVersion: string): 'major' | 'minor' | 'patch' | 'prerelease' | 'downgrade' | 'same' {
  try {
