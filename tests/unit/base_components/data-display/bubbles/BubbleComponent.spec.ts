  ...
  describe("Accessibility", () => {
    ...
    it("preserves slot content for screen readers", () => {
      const accessibleWrapper = mount(BubbleComponent, {
        slots: {
          content:
            '<span role="text" aria-label="Important information">Content</span>',
        },
      });

      expect(accessibleWrapper.html()).toContain('role="text"');
      expect(accessibleWrapper.html()).toContain(
      ...
      const patchableVariants = [
        {
          prop: "patchable",
          bgClass: "bg-[#e9ffe8]",
          textClass: "text-[#78995a]",
        },
        {
          prop: "notPatchable",
          bgClass: "bg-[#ffe8e8]",
          textClass: "text-[#995a5a]",
        },
        {
          prop: "partiallyPatchable",
          bgClass: "bg-[#fff6e8]",
          textClass: "text-[#99705a]",
        },
      ];
