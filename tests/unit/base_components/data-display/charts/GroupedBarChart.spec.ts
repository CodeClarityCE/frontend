...
} from "@/base_components/data-display";
...
const mockBandScale = {
  range: vi.fn(function (this: typeof mockBandScale) {
    return this;
  }),
  domain: vi.fn(function (this: typeof mockBandScale) {
    return this;
  }),
...
const mockLinearScale = {
  domain: vi.fn(function (this: typeof mockLinearScale) {
    return this;
  }),
  ...
  describe("Data Handling", () => {
    ...
    it("handles single category", () => {
      const singleCategoryData: GroupedBarChartData = {
        categories: ["Single"],
        groups: [{ name: "Group1", color: "#dc2626", data: [5] }],
      };
    ...
    it("handles single group", () => {
      const singleGroupData: GroupedBarChartData = {
        categories: ["Q1", "Q2", "Q3"],
        groups: [{ name: "OnlyGroup", color: "#dc2626", data: [1, 2, 3] }],
      };
    ...
    it("handles large numbers", () => {
      const largeData: GroupedBarChartData = {
        categories: ["Big"],
        groups: [{ name: "Large", color: "#dc2626", data: [999999] }],
      };
    ...
    it("handles negative values", () => {
      const negativeData: GroupedBarChartData = {
        categories: ["Neg", "Pos"],
        groups: [{ name: "Mixed", color: "#dc2626", data: [-5, 10] }],
      };
  ...
  describe("Edge Cases", () => {
    ...
    it("handles extremely small values", () => {
      const smallData: GroupedBarChartData = {
        categories: ["Tiny"],
        groups: [{ name: "Small", color: "#dc2626", data: [0.001] }],
      };
    ...
    it("handles long category names", () => {
      const longNameData: GroupedBarChartData = {
        ...
        groups: [{ name: "Group", color: "#dc2626", data: [5] }],
      };
      ...
      expect(wrapper.props().data.categories[0]).toBe(
    ...
    it("handles long group names", () => {
      const longGroupData: GroupedBarChartData = {
        ...
        groups: [
          {
            name: "Very Long Group Name That Might Cause Issues",
            color: "#dc2626",
            data: [3],
          },
        ],
      ...
      expect(wrapper.props().data.groups[0]!.name).toBe(
        "Very Long Group Name That Might Cause Issues",
      );
    });
    ...
    it("handles special characters in names", () => {
      const specialData: GroupedBarChartData = {
        categories: ["Category@#$%"],
        groups: [{ name: "Group!@#", color: "#dc2626", data: [1] }],
      };
    ...
    it("handles invalid color values gracefully", () => {
      const invalidColorData: GroupedBarChartData = {
        categories: ["A"],
        groups: [{ name: "Invalid", color: "not-a-color", data: [2] }],
      };
    ...
    it("handles empty data arrays", () => {
      const emptyArrayData: GroupedBarChartData = {
        categories: ["A", "B"],
        groups: [{ name: "Empty", color: "#dc2626", data: [] }],
      };
  ...
  describe("Data Structure Validation", () => {
    it("validates categories structure", () => {
      const validData: GroupedBarChartData = {
        categories: ["A", "B", "C"],
        groups: [{ name: "Group1", color: "#dc2626", data: [1, 2, 3] }],
      };
    ...
    it("validates groups structure", () => {
      ...
      groups.forEach(
        (group: { name: string; color: string; data: number[] }) => {
