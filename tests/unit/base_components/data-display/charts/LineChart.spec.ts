...
const mockBandScale = {
  rangeRound: vi.fn(function (this: typeof mockBandScale) {
    return this;
  }),
  padding: vi.fn(function (this: typeof mockBandScale) {
    return this;
  }),
...
const mockArea = {
  x: vi.fn(function (this: typeof mockArea) {
    return this;
  }),
  y: vi.fn(function (this: typeof mockArea) {
    return this;
  }),
  curve: vi.fn(function (this: typeof mockArea) {
    return this;
  }),
};
...
vi.mock("d3", () => {
  const mockAxis = {
    ticks: vi.fn(function (this: typeof mockAxis) {
      return this;
    }),
    tickSizeOuter: vi.fn(function (this: typeof mockAxis) {
      return this;
    }),
  };
...
describe("LineChart", () => {
  ...
  describe("Edge Cases", () => {
    ...
    it("handles long label names", () => {
      ...
      expect(wrapper.props().chartData.labels[0]).toBe(
        "Very Long Label Name That Might Cause Layout Issues",
      );
    });
