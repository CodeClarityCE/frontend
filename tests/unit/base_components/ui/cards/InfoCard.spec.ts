...
describe("InfoCard", () => {
  ...
  describe("Variant Styling", () => {
    ...
    it("applies primary variant styling", () => {
      ...
      expect(wrapper.find(".card").classes()).toContain(
  ...
  describe("Slot Functionality", () => {
    it("renders default slot content when provided", () => {
      ...
      expect(wrapper.find(".card-content p").text()).toBe(
    ...
    it("handles both default and actions slots", () => {
      ...
      expect(wrapper.find(".card-content .main-content").text()).toBe(
        "Main content here",
      );
  ...
  describe("Accessibility", () => {
    ...
    it("applies semantic text styling classes", () => {
      ...
      expect(wrapper.find(".card-title").classes()).toContain(
        "text-theme-black",
      );
      expect(wrapper.find(".card-description").classes()).toContain(
        "text-theme-gray",
      );
    });
  });
