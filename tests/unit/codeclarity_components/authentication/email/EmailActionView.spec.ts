...
vi.mock(
  "@/codeclarity_components/organizations/invites/OrganizationJoin.vue",
  async () => {
    ...
    return {
      default: defineComponent({
        ...
        template:
          '<div data-testid="email-action-join-org">Join Organization Component</div>',
      }),
    };
  },
);
...
vi.mock(
  "@/codeclarity_components/authentication/email/PasswordResetForm.vue",
  async () => {
    const { defineComponent } = await import("vue");
    return {
      default: defineComponent({
        ...
        template:
          '<div data-testid="password-reset-form">Password Reset Form Component</div>',
      }),
    };
  },
);
...
vi.mock(
  "@/codeclarity_components/authentication/email/ConfirmRegistration.vue",
  async () => {
    const { defineComponent } = await import("vue");
    return {
      default: defineComponent({
        ...
        template:
          '<div data-testid="confirm-registration">Confirm Registration Component</div>',
      }),
    };
  },
);
...
describe("EmailActionView", () => {
  ...
  describe("Conditional Rendering", () => {
    it('should render EmailActionJoinOrg when page prop is "join_org"', () => {
      ...
      const joinOrgComponent = wrapper.find(
        '[data-testid="email-action-join-org"]',
      );
      const passwordResetForm = wrapper.find(
        '[data-testid="password-reset-form"]',
      );
      const confirmRegistration = wrapper.find(
