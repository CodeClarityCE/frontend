...
vi.mock("@/base_components/ui/loaders/LoadingSubmitButton.vue", async () => {
  ...
  return {
    default: defineComponent({
      ...
      template:
        '<button type="submit" data-testid="submit-button"><slot></slot></button>',
    }),
  };
});
...
vi.mock("vue-router", async () => {
  ...
  return {
    RouterLink: defineComponent({
      ...
      template:
        '<a :href="to.name" :class="$props.class" :style="$props.style" data-testid="router-link"><slot></slot></a>',
    }),
    default: {
      push: vi.fn(),
    },
...
describe("PasswordResetForm", () => {
  ...
  describe("Component Structure", () => {
    ...
    it("should render form elements when not in success state", async () => {
      ...
      const confirmInput = wrapper.find(
        '[data-testid="new_password_comfirmation-input"]',
      );
  ...
  describe("Form Submission", () => {
    ...
    it("should handle button loading state during submission", async () => {
      ...
      const loadingButton = wrapper.findComponent(
  ...
  describe("Error Handling", () => {
    ...
    it("should show non-recoverable error for expired token", async () => {
      const businessError = new BusinessLogicError(
        APIErrors.PasswordResetTokenInvalidOrExpired,
    ...
    it("should reset error state on new submission", async () => {
      mockAuthRepository.resetPassword.mockRejectedValueOnce(
        new Error("Error"),
      );
  ...
  describe("Accessibility", () => {
    ...
    it("should have descriptive placeholders", async () => {
      ...
      expect(confirmInput.attributes("placeholder")).toBe(
